      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="mt-4 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/auth/signup" className="text-[#a435f0] font-bold hover:text-[#8710d8]">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded">
          <p className="text-sm font-bold text-[#1c1d1f] mb-2 text-center">Demo Accounts</p>
          <div className="space-y-2 text-xs text-gray-600">
            <div className="flex justify-between">
              <span className="font-medium">Teacher:</span>
              <span className="font-mono">sarah.johnson@gmail.com</span>
            </div>
            <div className="flex justify-between">
              <span className="font-medium">School:</span>
              <span className="font-mono">greenvalley@school.za</span>
            </div>
          </div>
          <p className="mt-2 text-xs text-gray-500 text-center">Use any password</p>
        </div>
      </div>
    </div>
  );
