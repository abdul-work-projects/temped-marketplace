    ...
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="space-y-4">
          <Card
            className={`cursor-pointer transition-all hover:shadow-md hover:border-primary ${selecting === 'teacher' ? 'border-primary shadow-md' : ''} ${selecting !== null ? 'opacity-50 pointer-events-none' : ''}`}
          ...
          >
            <CardContent className="flex items-center gap-4 p-6">
              ...
              <div className="text-left">
                <p className="font-bold text-foreground text-lg">I&apos;m a Teacher</p>
                <p className="text-sm text-muted-foreground">Find teaching opportunities at schools</p>
              </div>
            </CardContent>
          </Card>

          <Card
            className={`cursor-pointer transition-all hover:shadow-md hover:border-primary ${selecting === 'school' ? 'border-primary shadow-md' : ''} ${selecting !== null ? 'opacity-50 pointer-events-none' : ''}`}
          ...
          >
            <CardContent className="flex items-center gap-4 p-6">
              ...
              <div className="text-left">
                <p className="font-bold text-foreground text-lg">I&apos;m a School</p>
                <p className="text-sm text-muted-foreground">Post jobs and find qualified teachers</p>
              </div>
            </CardContent>
          </Card>
        </div>
